...
An interactive dashboard and analysis report can be downloaded [here]([./Olist_Ecommerce.pbix](https://github.com/erickcalderon1399/Olist_Ecommerce/blob/main/Olist_Ecommerce.pbix)).
